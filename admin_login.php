    ...
    <div class="container-fluid m-3">
        ...
        <div class="row d-flex justify-content-center">
            <!-- <div class="col-lg-6 col-xl-5">
                <img src="../images/image.jpg" alt="Admin Registration" class="img-fluid">
            </div> -->
            <div class="col-lg-6 col-xl-4">
               <form action="" method="post">
                ...
                <div class="form-outline mb-4">
                    ...
                    <input type="text" id="password" name="password" placeholder="Enter your password" required="required" class="form-control">
                </div>
