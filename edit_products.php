...
<div class="container mt-5">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <input type="text" id="$product_desc" value="<?php echo $product_description?>" name="product-desc" class="form-control" required="required"> 
        </div>
        <div class="form-outline w-50 m-auto mb-4">
            <label for="product_keywords" class="form-label">Product Keywords</label>
            <input type="text" id="$product_keywords"  value="<?php echo $product_keywords?>" name="product-keywords" class="form-control" required="required"> 
        </div>
        <div class="form-outline w-50 m-auto mb-4">
...
?>
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
            <input type="file" id="$product_image1" name="product-image1" class="form-control w-90 m-auto" required="required"> 
            ...
            <div class="d-flex">
            <input type="file" id="$product_image2" name="product-image2" class="form-control w-90 m-auto" required="required"> 
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
            <input type="file" id="$product_image3" name="product-image3" class="form-control w-90 m-auto" required="required"> 
            <img src="./product_images/<?php echo $product_image3?>" alt="" class="product_img">
            </div>
</div>
<div class="form-outline w-50 m-auto mb-4">
            <label for="product_price" class="form-label">Product Price</label>
            <input type="text" id="$product_price" value="<?php echo $product_price?>/-" name="product-price" class="form-control" required="required"> 
        </div>
