...
if(isset($_POST['insert_product'])){
    ...
    if($product_title=='' or $description=='' or $product_keywords=='' or $product_category=='' or $product_brands=='' or $product_image1=='' or $product_image2=='' or  $product_image3=='' or  $product_price=='' ){
...
<body class="bg-light">
    <div class="container mt-3">
        ...
        <!-- form -->
        <form action="" method="post" enctype="multipart/form-data">          <!--enctype="multipart/form-data" is used to insert the images-->
